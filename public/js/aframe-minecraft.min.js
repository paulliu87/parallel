...
THREEx.Animation.prototype.start = function() {
	...
	var startDate = Date.now() / 1e3;
	var duration = this.duration();
	this._$loopCb = function() {
		var age = Date.now() / 1e3 - startDate;
...
THREEx.MinecraftChar = function(skinUrl) {
	...
	mapUv(geometry, 0, 16, 24, 24, 16);
	mapUv(geometry, 1, 0, 24, 8, 16);
	mapUv(geometry, 2, 8, 32, 16, 24);
	mapUv(geometry, 3, 16, 32, 24, 24);
	mapUv(geometry, 4, 8, 24, 16, 16);
	mapUv(geometry, 5, 24, 24, 32, 16);
	...
	mapUv(geometry, 0, 48, 24, 56, 16);
	mapUv(geometry, 1, 32, 24, 40, 16);
	mapUv(geometry, 2, 40, 32, 48, 24);
	mapUv(geometry, 3, 48, 32, 56, 24);
	mapUv(geometry, 4, 40, 24, 48, 16);
	mapUv(geometry, 5, 56, 24, 64, 16);
	...
	mapUv(geometry, 0, 28, 12, 32, 0);
	mapUv(geometry, 1, 16, 12, 20, 0);
	mapUv(geometry, 2, 20, 16, 28, 12);
	mapUv(geometry, 3, 28, 16, 32, 12);
	mapUv(geometry, 4, 20, 12, 28, 0);
	mapUv(geometry, 5, 32, 12, 40, 0);
	...
	mapUv(geometry, 0, 48, 12, 52, 0);
	mapUv(geometry, 1, 40, 12, 44, 0);
	mapUv(geometry, 2, 44, 16, 48, 12);
	mapUv(geometry, 3, 48, 16, 52, 12);
	mapUv(geometry, 4, 44, 12, 48, 0);
	mapUv(geometry, 5, 52, 12, 56, 0);
	var geometry = new THREE.CubeGeometry(sizes.armW, sizes.armH, sizes.armD);
	...
	mapUv(geometry, 0, 44, 12, 40, 0);
	mapUv(geometry, 1, 52, 12, 48, 0);
	mapUv(geometry, 2, 44, 16, 48, 12);
	mapUv(geometry, 3, 48, 16, 52, 12);
	mapUv(geometry, 4, 48, 12, 44, 0);
	mapUv(geometry, 5, 56, 12, 52, 0);
	...
	mapUv(geometry, 0, 8, 12, 12, 0);
	mapUv(geometry, 1, 0, 12, 4, 0);
	mapUv(geometry, 2, 4, 16, 8, 12);
	mapUv(geometry, 3, 8, 16, 12, 12);
	mapUv(geometry, 4, 4, 12, 8, 0);
	mapUv(geometry, 5, 12, 12, 16, 0);
	var geometry = new THREE.CubeGeometry(sizes.legW, sizes.legH, sizes.legD);
	...
	mapUv(geometry, 0, 4, 12, 0, 0);
	mapUv(geometry, 1, 12, 12, 8, 0);
	mapUv(geometry, 2, 8, 16, 4, 12);
	mapUv(geometry, 3, 12, 16, 8, 12);
	mapUv(geometry, 4, 8, 12, 4, 0);
	mapUv(geometry, 5, 16, 12, 12, 0);
	return;
...
THREEx.MinecraftBubble = function(character) {
	...
	this.update = function(delta, now) {
		...
		var sayAge = (Date.now() - _this._createdAt) / 1e3;
...
THREEx.MinecraftCharBodyAnimations = function(character) {
	...
	animations.add("run", THREEx.createAnimation().pushKeyframe(.5, {
	...
	animations.add("strafe", THREEx.createAnimation().pushKeyframe(.5, {
	...
	animations.add("walk", THREEx.createAnimation().pushKeyframe(.5, {
	...
	animations.add("stand", THREEx.createAnimation().pushKeyframe(.3, {
		armLRotationZ: 0,
		armRRotationZ: 0,
		armRotationX: 0,
		legLRotationZ: 0,
	...
	animations.add("jump", THREEx.createAnimation().pushKeyframe(.15, {
		armLRotationZ: +3 * Math.PI / 4,
		armRRotationZ: -3 * Math.PI / 4,
		armRotationX: +angleRange,
		legRotationX: +angleRange
	}).propertyTweens(propTweens).onCapture(onCapture).onUpdate(onUpdate));
	animations.add("fall", THREEx.createAnimation().pushKeyframe(.5, {
	...
	var angleRange = Math.PI / 2 - Math.PI / 10;
	animations.add("wave", THREEx.createAnimation().pushKeyframe(.5, {
		armLRotationZ: 0,
	...
	var angleRange = Math.PI / 2 - Math.PI / 10;
	animations.add("hiwave", THREEx.createAnimation().pushKeyframe(.5, {
		armLRotationZ: Math.PI - 3 * Math.PI / 5,
		armRRotationZ: Math.PI + 3 * Math.PI / 5,
		armRotationX: 0,
		legRotationX: 0
	...
	var angleRange = Math.PI / 2 - Math.PI / 10;
	animations.add("rightPunch", THREEx.createAnimation().pushKeyframe(.1, {
		armLRotationZ: +Math.PI / 10,
		armRRotationZ: -Math.PI / 10,
		armRotationX: 0,
		legRotationX: 0
...
THREEx.MinecraftCharHeadAnimations = function(character) {
	...
	animations.add("still", THREEx.createAnimation().pushKeyframe(.5, {
		headRotationX: 0,
		headRotationY: 0
	}).propertyTweens(propTweens).onCapture(onCapture).onUpdate(onUpdate));
	animations.add("no", THREEx.createAnimation().pushKeyframe(.5, {
		headRotationX: 0,
	...
	animations.add("yes", THREEx.createAnimation().pushKeyframe(.4, {
		headRotationY: 0,
...
AFRAME.registerComponent("minecraft-head-anim", {
	...
	tick: function(now, delta) {
		this.headAnims.update(delta / 1e3, now / 1e3)
	},
	update: function() {
		if (Object.keys(this.data).length === 0) return;
...
AFRAME.registerComponent("minecraft-body-anim", {
	...
	tick: function(now, delta) {
		...
		this.bodyAnims.update(delta / 1e3, now / 1e3)
	},
	update: function() {
		if (Object.keys(this.data).length === 0) return;
...
AFRAME.registerComponent("minecraft-bubble", {
	...
	tick: function(now, delta) {
		this.bubble.update(delta / 1e3, now / 1e3)
	}
});
AFRAME.registerComponent("minecraft-controls", {
	...
	tick: function(now, delta) {
		this.controls.update(delta / 1e3, now / 1e3)
	}
});