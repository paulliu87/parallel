! function(e) {
	...
	var s = i(1),
		o = n(s);
	if ("undefined" == typeof AFRAME) throw "mouse-cursor Component attempted to register before AFRAME was available.";
	...
	AFRAME.registerComponent("mouse-cursor", {
		...
		_attachEventListeners: function() {
			var e = this.el,
				t = e.sceneEl,
				i = t.canvas;
			return i ? (window.addEventListener("resize", this.__getCanvasPos), document.addEventListener("scroll", this.__getCanvasPos), this._getCanvasPos(), t.addEventListener("enter-vr", this.__onEnterVR), t.addEventListener("exit-vr", this.__onExitVR), i.addEventListener("mousedown", this.__onDown), i.addEventListener("mousemove", this.__onMouseMove), i.addEventListener("mouseup", this.__onRelease), i.addEventListener("mouseout", this.__onRelease), i.addEventListener("touchstart", this.__onDown), i.addEventListener("touchmove", this.__onTouchMove), i.addEventListener("touchend", this.__onRelease), i.addEventListener("click", this.__onClick), void e.addEventListener("componentchanged", this.__onComponentChanged)) : void e.sceneEl.addEventListener("render-target-loaded", this._attachEventListeners.bind(this))
		},
		_removeEventListeners: function() {
			var e = this.el,
				t = e.sceneEl,
				i = t.canvas;
			i && (window.removeEventListener("resize", this.__getCanvasPos), document.removeEventListener("scroll", this.__getCanvasPos), t.removeEventListener("enter-vr", this.__onEnterVR), t.removeEventListener("exit-vr", this.__onExitVR), i.removeEventListener("mousedown", this.__onDown), i.removeEventListener("mousemove", this.__onMouseMove), i.removeEventListener("mouseup", this.__onRelease), i.removeEventListener("mouseout", this.__onRelease), i.removeEventListener("touchstart", this.__onDown), i.removeEventListener("touchmove", this.__onTouchMove), i.removeEventListener("touchend", this.__onRelease), i.removeEventListener("click", this.__onClick), e.removeEventListener("componentchanged", this.__onComponentChanged))
		},
		_isActive: function() {
			return !(!this._active && !this._raycaster)
		},
		_onDown: function(e) {
			this._isActive() && (this._isDown = !0, this._updateMouse(e), this._updateIntersectObject(), this._isMobile || this._setInitMousePosition(e), this._intersectedEl && this._emit("mousedown"))
		},
		_onClick: function(e) {
			this._isActive() && (this._updateMouse(e), this._updateIntersectObject(), this._intersectedEl && this._emit("click"))
		},
		_onRelease: function() {
			if (this._isActive()) {
				if (this._defMousePosition) {
					var e = Math.abs(this._initMousePosition.x - this._defMousePosition.x),
						t = Math.abs(this._initMousePosition.y - this._defMousePosition.y),
						i = Math.max(e, t);
					i > .04 && (this._isDown = !1)
				}
		...
		_onMouseMove: function(e) {
			this._isActive() && (this._updateMouse(e), this._updateIntersectObject(), this._isDown && this._setMousePosition(e))
		},
		...
		_updateIntersectObject: function() {
			...
			this._getAllChildren(), e.ray.origin.setFromMatrixPosition(n.matrixWorld), e.ray.direction.set(i.x, i.y, .5).unproject(n).sub(e.ray.origin).normalize();
			...
			if (o.length > 0) {
				...
				if (o.every(function(e) {
					...
					}), !r) return void this._clearIntersectObject();
				var h = r.parent.el;
		...
		_setIntersectObject: function(e) {
			this._intersectedEl = e, this._isMobile || (e.addState("hovered"), e.emit("mouseenter"), this.el.addState("hovering"))
		},
		_clearIntersectObject: function() {
			var e = this._intersectedEl;
			e && !this._isMobile && (e.removeState("hovered"), e.emit("mouseleave"), this.el.removeState("hovering")), this._intersectedEl = null
		},
		_emit: function(e) {
